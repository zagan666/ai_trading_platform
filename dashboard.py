...
st.title("AI Trading Strategy Backtesting Platform")
...
if st.sidebar.button("Run Backtest"):
    with st.spinner("Running backtest, please wait..."):
        try:
            ...
            fig.add_trace(go.Scatter(x=performance_df.index, y=performance_df['benchmark'], mode='lines', name='Benchmark (Buy & Hold)'))
    ...
    st.info("Please set the parameters on the left and click 'Run Backtest'.")